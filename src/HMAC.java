...
public class HMAC {
	 ...
	 *            The secret key
	 */
	public HMAC(MessageDigest digest, String key) {
		digest.reset();
		this.digest = digest;
		init(key.getBytes());
	}
	 ...
	 */
	public HMAC(String digestName, String key) {
	...
	/*
	 * Compute HMAC for file by DigestInputStream
	 * 
	 * */
	public byte[] signFile(String fileDirect) throws GeneralSecurityException, IOException{
		
		File f = new File(fileDirect);
